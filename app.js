...
function _loadTopicContent(unitIdx, topicIdx) {
  ...
  let steps    = `
    <div class="step-block"><div class="step-label">Step 1</div><div class="step-content">Step 1 for ${name} goes here. To implement, set the <code>steps</code> variable for this topic in <code>_loadTopicContent()</code> in <code>app.js</code>.</div></div>
    <div class="step-block"><div class="step-label">Step 2</div><div class="step-content">Step 2 goes here.</div></div>
    <div class="step-block"><div class="step-label">Step 3</div><div class="step-content">Step 3 goes here.</div></div>
  `;
  let problems = `
  ...
  // Inject intuition — 2×2 grid with image gallery
  document.getElementById('ti-content').innerHTML = `
    <div class="intuition-row">
      <div class="intuition-block">
        <div class="intuition-label">My Interpretation</div>
        <div class="intuition-text ph">${intuitionText}</div>
      </div>
      <div class="intuition-block">
        <div class="intuition-label">Personal Notes / Annotations</div>
        <div class="intuition-gallery">
          <div class="intuition-gallery-frame">
    ...
    <div class="intuition-row" style="margin-top:1.4rem;">
      <div class="intuition-block">
        <div class="intuition-label">What Clicked First</div>
        <div class="intuition-text ph">${clickedFirst}</div>
      </div>
      <div class="intuition-block">
        <div class="intuition-label">What Confused Me Initially</div>
        <div class="intuition-text ph">${confusedBy}</div>
      </div>
    </div>
  `;
...
function openMystery(idx) {
  ...
  document.getElementById('mr-content').innerHTML = `
    <div class="step-block"><div class="step-label">Result 1</div><div class="step-content">Known result for Exhibit 0${idx + 1} goes here. To implement, locate <code>mr-content</code> in <code>openMystery()</code> in <code>app.js</code>.</div></div>
    <div class="step-block"><div class="step-label">Result 2</div><div class="step-content">Known result goes here.</div></div>
  `;
